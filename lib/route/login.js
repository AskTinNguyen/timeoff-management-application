  ...
  router.post('/register', function(req, res){
      ...
      .then(function(user){
        ...
        req.logIn(user, function(err) {
          ...
          // Try to send registration email but don't fail if it doesn't work
          var email = new EmailTransport();
          email.promise_registration_email({
            user : user,
          })
          .catch(function(error){
            console.error('Failed to send registration email but proceeding. Error: ', error);
          })
          .finally(function(){
